#line 1 "Pattern_RGBPatterns.c"
#line 1 "Pattern_RGBPatterns.c"

#line 18 "Pattern_RGBPatterns.c"
 

 

#line 23 "Pattern_RGBPatterns.c"
...
#line 34 "Pattern_RGBPatterns.c"
#line 35 "Pattern_RGBPatterns.c"

 

 

#line 41 "Pattern_RGBPatterns.c"
 

 
static	uint32_t PixelPattern[30 ];
...
#line 52 "Pattern_RGBPatterns.c"
static  uint32_t GenColors[13 ]={
    0xFF0000 ,
    0xFFA500 ,
    0xFFFF00 ,
    0x808000 ,
...
uint32_t * UpdatePattern(void){
    ...
    uint8_t patternID = PatternConfigs[1 ];
    uint8_t brightness = PatternConfigs[2 ];
    ...
    switch(patternID){
        ...
        case 0xFF :
            ...
            if(PatternStepCounter++%Length == 0){
                TestColor = TestColor++%13 ;
            }
        break;
#line 116 "Pattern_RGBPatterns.c"
    }
