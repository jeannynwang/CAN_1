...
#define SERV_0_HEADER "Can_XmitService.h"
// the name of the Init function
#define SERV_0_INIT InitCan_XmitService
// the name of the run function
#define SERV_0_RUN RunCan_XmitService
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "ToggleService.h"
// the name of the Init function
#define SERV_1_INIT InitToggleService
// the name of the run function
#define SERV_1_RUN RunToggleService
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "SPI32_ControlService.h"
// the name of the Init function
#define SERV_2_INIT InitSPI32ControlService
// the name of the run function
#define SERV_2_RUN RunSPI32ControlService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "SPI32_ControlService.h"
// the name of the Init function
#define SERV_3_INIT InitSPI32ControlService
// the name of the run function
#define SERV_3_RUN RunSPI32ControlService
// How big should this services Queue be?
